            ...
            <Dialog.Title className='text-3xl text-white font-black'>Publique um anúncio</Dialog.Title>
              <form className='mt-8 flex flex-col gap-4'>
                <div  className='flex flex-col gap-2'>
                  ...
                  <select defaultValue="" className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 apperance-none' id="game">
                ...
                <div className='flex gap-6'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <ToggleGroup.Root type="multiple" className='grid grid-cols-4 gap-2 ' onValueChange={console.log}>
